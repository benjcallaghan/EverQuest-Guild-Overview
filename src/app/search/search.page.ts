...
export class SearchPage {
  ...
  public async search() {
    this.searchResults = await this.census.getGuilds(this.serverInput.value, [
      ...this.guilds,
    ]);
    this.filteredPlayers = flatten<any>(
      this.searchResults.guild_list.map((guild) => guild.member_list)
