...
export class PlanesOfProphecyPage implements OnInit {
  ...
  public characters: QuestResults<typeof PlanesOfProphecyPage.achievements>;
  ...
  async ngOnInit(): Promise<void> {
    ...
    try {
      ...
      this.characters = await this.census.queryQuestStatus(
        ids,
        PlanesOfProphecyPage.achievements
      );
    } finally {
